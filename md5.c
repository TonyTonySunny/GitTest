...
/*********************************************************************
*函数名称：MD5
*功能说明：计算一串数据的MD5字符串，已大写形式输出
*输入参数：In        需要计算MD5的数据缓冲
*输出参数：Inlen     数据缓冲长度
*  返回值：无
***********************************************************************/
void MD5(const char *In, int Inlen, char *Out)
{
